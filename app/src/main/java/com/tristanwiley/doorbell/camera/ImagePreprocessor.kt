package com.tristanwiley.doorbell.camera
...
class ImagePreprocessor(previewWidth: Int, previewHeight: Int,
    ...
    private var rgbFrameBitmap: Bitmap = Bitmap.createBitmap(previewWidth, previewHeight, Config.ARGB_8888)
    private val croppedBitmap: Bitmap = Bitmap.createBitmap(croppedwidth, croppedHeight, Config.ARGB_8888)
